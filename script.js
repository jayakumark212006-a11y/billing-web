...
const defaultMenu = [
  { id: crypto.randomUUID(), name: "Methu Vada", price: 12, category: "Snack", image: "assets/methu-vada.svg" },
  { id: crypto.randomUUID(), name: "Paruppu Vada", price: 10, category: "Snack", image: "assets/paruppu-vada.svg" },
  { id: crypto.randomUUID(), name: "Tea", price: 15, category: "Drink", image: "assets/tea.svg" },
  { id: crypto.randomUUID(), name: "Coffee", price: 20, category: "Drink", image: "assets/coffee.svg" },
  { id: crypto.randomUUID(), name: "Butter Milk", price: 18, category: "Drink", image: "assets/butter-milk.svg" },
  { id: crypto.randomUUID(), name: "Lemon Juice", price: 25, category: "Drink", image: "assets/lemon-juice.svg" }
];
...
function handleMenuSubmit(event) {
  ...
  const menuItem = {
    ...
    price,
    category,
    image: image || getFallbackImage(name, category)
  };
...
function loadMenu() {
  ...
  try {
    ...
    return Array.isArray(parsed) && parsed.length ? parsed : defaultMenu;
  } catch {
    return defaultMenu;
  }
}
